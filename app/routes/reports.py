...
def analytics():
    ...
    # 1. KPI CARDS (Stats for Current Month)
    ...
    # 3. VENDOR SHARE (Pie Chart Data) - All Time
    vendor_share_query = db.session.query(
        Entry.vendor,
        func.sum(Entry.total).label('total_rev')
    ...
    return render_template('analytics.html',
                           ...
                           kpi_parcels=kpi_parcels,
                           kpi_avg_price=round(kpi_avg_price, 2),
                           kpi_vendors=kpi_vendors_active,
